...
#Region "████████████████  QUINTA CAPA  █████████       Reglas locales         ██████████████████████████████"
    ...
    Public Sub dbc_NumFacturaAcuseValor_Click(sender As Object, e As EventArgs)
        ...
        '''Dim institucionBancaria_ As New InstitucionBancaria With {._id = ObjectId.GenerateNewId,
        '''                                                     .idinstitucionbancaria = 1,
        '''                                                     .idempresa = ObjectId.GenerateNewId,
        '''                                                     .iddomicilio = ObjectId.GenerateNewId,
        '''                                                     .identificadorbanco = "40002",
        '''                                                     .clavesat = "002",
        ...
        '''                                                                                                    .Valor = "BANAMEX"},
        '''                                                                             New AliasBancos With {.TipoAlias = "Inglés",
        '''                                                                                                    .Valor = "CITYBANAMEX"},
        '''                                                                             New AliasBancos With {.TipoAlias = "Abreviatura",
        '''                                                                                                    .Valor = "BANAMEX"},
        '''                                                                             New AliasBancos With {.TipoAlias = "Anterior",
        '''                                                                                                    .Valor = "BANAMEX"}
        '''                                                                                                    },
        '''                                                     .razonsocialespaniol = "Banco Nacional de México, S.A., Institución de Banca Múltiple, Grupo Financiero Banamex ".ToUpper,
        '''                                                     .domiciliofiscal = "Algún Lugar",
        '''                                                     .tipobanco = TiposBanco.Nacional,
        '''                                                     .estado = 1,
        '''                                                     .archivado = False
        '''                                                        }

        'Dim Algo2 = ctrlBanco_.ActualizaBanco(New ObjectId("64dd04cbbc77423401c28cf7"), New Dictionary(Of IControladorInstitucionBancaria.CamposBusquedaSimple, Object) From
        ...
        '                                    {IControladorInstitucionBancaria.CamposBusquedaSimple.NUMIDBANCARIA,
        '                                    "40012"},
        '                                    {IControladorInstitucionBancaria.CamposBusquedaSimple.NOMBRECOMERCIAL,
        '                                    New AliasBancos With {.TipoAlias = "Abreviatura", .Valor = "BBVA"}}
        '                                    })

        ''Dim Algo2 = ctrlBanco_.NuevoBanco(institucionBancaria_)

        'Dim Allgo = _ControladorMonedas.ObtenerFactorTipodeCambio("EUR", Date.Parse("15/09/2023"))
            ...
            If dbc_NumFacturaAcuseValor.Value.ToString <> "" Then
                ...
                If resultado_ IsNot Nothing Then
                    ...
                    Else
                        ...
                        If DirectCast(listaResultado_.Item(9), Campo).Valor IsNot Nothing Then
                            ...
                            Else
                                ...
                                iindiceaux_ = identificacionPersona_.IndexOf("-")
                    ...
                    If identificacionPersona_ <> "" Then
                        ...
                        If proveedorAcuseValor_ IsNot Nothing Then
                            ...
                            If proveedorAcuseValor_.Seccion(SeccionesProvedorOperativo.SPRO2).
                                ...
                                If tipoIdentificador_ = "RAZÓN SOCIAL" Then
                    ...
                    Else
                        ...
                        If DirectCast(listaResultado_.Item(5), Campo) Is Nothing Then
